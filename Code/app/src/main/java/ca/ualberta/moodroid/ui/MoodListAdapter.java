...
////////////////////////////////go to fragment....delete from db using moodEventService.deleteEvent
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if(moodStr.equals("Angry")){
            // holder.imageView.setImageResourceBackground(moodModel.getEmoji());  //change image to correct emoji for mood
            ...
            // holder.imageView.setImageResourceBackground(moodModel.getEmoji());  //get image from model....
