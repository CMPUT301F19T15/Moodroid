...
public class CreateMoodEventHappyTest {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void createMoodEventHappyTest() {
                ...
                allOf(withId(R.id.mood_detail_reason),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        1),
                                1)));
        appCompatEditText.perform(scrollTo(), replaceText("rock is dead"), closeSoftKeyboard());
