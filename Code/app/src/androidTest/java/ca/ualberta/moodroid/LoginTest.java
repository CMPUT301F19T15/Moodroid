...
public class LoginTest {
    ...
    /*
    This test works, note that you need to call sleep or else the elements aren't found
     */
    @Test
                ...
                allOf(withId(R.id.email),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        textInputEditText.perform(scrollTo(), replaceText("test@test.ca"), closeSoftKeyboard());
        ...
        ViewInteraction bottomNavigationItemView = onView(
                allOf(withId(R.id.ic_profile),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        //if you dont sleep it crashes???????
        sleep(1000);
        bottomNavigationItemView.perform(click());

        ViewInteraction textView = onView(
                allOf(withId(R.id.profile_user_name_text_view), withText("test test"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textView.check(matches(withText("test test")));
    }
